...
public class ArtistListAdapter extends RecyclerView.Adapter<ArtistListAdapter.VH> {
    ...
    public ArtistListAdapter(List<Artist> artists, OnArtistClickListener listener) {
