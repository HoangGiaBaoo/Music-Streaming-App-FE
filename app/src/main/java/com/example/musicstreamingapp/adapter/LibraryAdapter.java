...
public class LibraryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    static class RowVH extends RecyclerView.ViewHolder {
        ImageView cover; TextView title, subtitle;
        RowVH(@NonNull View v) {
            super(v);
            cover = v.findViewById(R.id.iv_lib_cover);
        ...
        void bind(Item it) {
            ...
            if (it.coverUrl != null) {
                Glide.with(itemView).load(RetrofitClient.BASE_MEDIA_URL + it.coverUrl)
                    .placeholder(R.drawable.placeholder_gradient).into(cover);
            } else {
                cover.setImageResource(R.drawable.placeholder_gradient);
            }
